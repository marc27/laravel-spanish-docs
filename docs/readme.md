...
La traducción de la documentación de Laravel 6 puede ser encontrada en [https://documentacion-laravel.com/](https://documentacion-laravel.com/)
...
Si estás enviando documentación para la **versión estable actual**, envíala a la rama correspondiente. Por ejemplo, la documentación para Laravel 7.0 se enviaría a la rama `7.0_press`. La documentación destinada a la próxima versión de Laravel debe enviarse a la rama `master`.
